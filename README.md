...
- [🛠 프로젝트 설계 🏗](#-프로젝트-설계-)
  ...
  - [🏗 시스템 아키텍처 🏛](#-시스템-아키텍처-)
  - [🛠 ERD 🗂](#-erd-)
- [🛠 프로젝트 내용 및 기능 🏗](#-프로젝트-내용-및-기능-)
  - [주요 내용](#주요-내용)
    - [1. 로그인 및 회원가입](#1-로그인-및-회원가입)
      - [1.1. 회원가입](#11-회원가입)
      - [1.2. 로그인](#12-로그인)
      - [1.3. 아이디와 비밀번호 찾기](#13-아이디와-비밀번호-찾기)
    - [2. 지도 작업 - 음식점 별 재료 이미지 마커](#2-지도-작업---음식점-별-재료-이미지-마커)
    - [3. 경험치 획득](#3-경험치-획득)
    - [4. 방문 음식점 기록](#4-방문-음식점-기록)
    - [5. 리뷰 작성](#5-리뷰-작성)
    - [6. 컬렉션 획득](#6-컬렉션-획득)
    - [7. 칭호 획득](#7-칭호-획득)
    - [8. 마이페이지](#8-마이페이지)
  - [주요 기능 영상](#주요-기능-영상)
- [📈 성능 개선](#-성능-개선)
  - [추가로 사용된 기술](#추가로-사용된-기술)
    - [✔ Monitoring](#-monitoring)
    - [✔ Dashboard](#-dashboard)
    - [✔ Load Testing](#-load-testing)
  - [지도 영역 내 음식점 정보 조회 API 성능 개선](#지도-영역-내-음식점-정보-조회-api-성능-개선)
    - [🔍 문제 인식](#-문제-인식)
    - [🛠️ 개선 방식](#️-개선-방식)
    - [📊 개선 결과 (k6 부하 테스트)](#-개선-결과-k6-부하-테스트)
  - [리뷰 조회 API 성능 개선](#리뷰-조회-api-성능-개선)
    - [🔍 문제 인식](#-문제-인식-1)
    - [🛠️ 개선 방식](#️-개선-방식-1)
    - [📊 개선 결과 (k6 부하 테스트)](#-개선-결과-k6-부하-테스트-1)
- [🛠 추후 계획](#-추후-계획)
